...
- Certify pm CLI 2026.9.23 and adopt the guarded pm-ops merge-driver launcher ([pm-starter-50az](https://github.com/unbraind/pm-starter/blob/main/.agents/pm/chores/pm-starter-50az.toon))

## 2026.9.22 - 2026-09-22

### Fixed

- A publish that npm accepts late is reported as failed and the GitHub Release is skipped on bun mirror lag ([pm-starter-4tq9](https://github.com/unbraind/pm-starter/blob/main/.agents/pm/issues/pm-starter-4tq9.toon))

### Other

- Certify pm CLI 2026.9.21 and install merge drivers through the canonical pm-ops launcher ([pm-starter-8vta](https://github.com/unbraind/pm-starter/blob/main/.agents/pm/tasks/pm-starter-8vta.toon))
...
- Certify pm CLI 2026.9.12 and the pm-ops 2026.9.11 auditor ([pm-starter-u8nj](https://github.com/unbraind/pm-starter/blob/main/.agents/pm/chores/pm-starter-u8nj.toon))

## 2026.9.11 - 2026-09-11

### Other

- Certify pm CLI 2026.9.10 and pick up the canonical auditor fixes the lockfile was holding back ([pm-starter-dco5](https://github.com/unbraind/pm-starter/blob/main/.agents/pm/chores/pm-starter-dco5.toon))
